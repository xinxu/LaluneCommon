...
//消息类型：同步战斗服务相关
#define MSG_TYPE_SYNC_BATTLE_CONNECT_TO_GAME (110000)
#define MSG_TYPE_SYNC_BATTLE_CONNECT_TO_GAME_RESPONSE (110001)
#define MSG_TYPE_SYNC_BATTLE_GAME_START (110003)

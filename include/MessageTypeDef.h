...
//消息类型：匹配服务相关
#define MSG_TYPE_AUTOMATCH_MATCH_REQUEST (100000) //客户端先发这个给匹配服，开始匹配
#define MSG_TYPE_AUTOMATCH_MATCH_RESPONSE (100001) //匹配服收到战斗服的确认后，告诉用户

//消息类型：同步战斗服务相关
#define MSG_TYPE_PVP_SERVER_CREATE_GAME (110006) //匹配服将一局的信息告诉战斗服
#define MSG_TYPE_PVP_SERVER_CREATE_GAME_RESPONSE (110007) //战斗服反馈成功或失败给匹配服
#define MSG_TYPE_PVP_SERVER_REGISTER (110010) //向匹配服注册战斗服
#define MSG_TYPE_PVP_SERVER_HEART_BEAT (110011) //战斗服务给匹配服务的心跳包，匹配服只会把游戏发给活着的战斗服务
...
#define MSG_TYPE_REFRESH_CONFIG_RESPONSE (500053)
#define MSG_TYPE_CMD2SERVER (500054)
#define MSG_TYPE_CONTROL_SERVER_FETCH_CONFIG_REQUEST (500056)
#define MSG_TYPE_CONTROL_SERVER_FETCH_CONFIG_RESPONSE (500057)
#define MSG_TYPE_CONTROL_SERVER_HASH_FUNCTION_INFO (500061)
#define MSG_TYPE_CONTROL_SERVER_HASH_FUNCTION_CHANGE (500063)
#define MSG_TYPE_CONTROL_SERVER_HASH_FUNCTION_CHANGE_ACCEPTED (500064)
#define MSG_TYPE_DENY_SERVICE_BECAUSE_HASH_CHANGE (500066)
...
#define SERVER_TYPE_PVP_SERVER (11)
#define SERVER_TYPE_MONGODB_SERVICE (12)
...
//error code
#define BOID_ERROR_NONE (0)
#define BOID_ERROR_SERVER_FAILED (1)
#define BOID_ERROR_DUPLICATE_USERNAME (2)
